...
class CleiTest(TestCase):
    ...
    def test_estados_seleccion(self):
        ...
        self.assertEquals(aceptados[0].id_articulo, 1)
        self.assertEquals(rechazados_promedio[0].id_articulo, 5) 
        self.assertEquals(rechazados_falta_cupo[0].id_articulo, 4)   
